...
class IconService
{
    ...
    // 取得廣告
    public function getIcons(int $siteId)
    {
        ...
        $result = Icon::where('start_time', '<=', $now)
    ...
    // 新增或更新廣告
    public function storeIcon(array $data): void
    {
        $model = Icon::findOrNew($data['id']);
