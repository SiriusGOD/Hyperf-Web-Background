                        ...
                        <div class="row">
                            <form action="/admin/manager/store" method="post" class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="name" id="name" @if(isset($user->name)) disabled="true" @endif
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="role_id">
                                        @foreach($roles as $role)
                                            <option value="{{$role->id}}" @if(isset($user)) {{($user->role_id==$role->id)?"selected=true":"" }}   @endif  >{{$role->name}}</option>
                                        @endforeach
                                    </select>
