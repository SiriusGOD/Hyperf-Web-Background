                    ...
                    <div id="example2_wrapper" class="dataTables_wrapper dt-bootstrap4">
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-12">
                                <a class="btn badge-info" href="/admin/manager/create">{{trans('default.manager_control.manager_insert') ?? '新增管理者'}}</a>
                            </div>
                            @endif
                        </div>
                        <div class="row">
                                        ...
                                        <tr class="odd">
                                            ...
                                            <td>
                                                @if(authPermission('manager-edit'))
                                                    <a href="/admin/manager/edit?id={{$user->id}}" class="btn btn-primary">{{trans('default.edit') ?? '編輯'}}</a>
                                                @endif
