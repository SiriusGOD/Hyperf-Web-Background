                ...
                <div class="card-body">
                    <div id="example2_wrapper" class="dataTables_wrapper dt-bootstrap4">
                        <div class="row">
                            ...
                            @if(authPermission('seo-create'))
                                <div class="col-sm-12 col-md-12 mb-1">
                                    <a class="btn badge-info" href="/admin/seo/create">{{trans('default.seo_control.seo_insert') ?? '新增seo關鍵字'}}</a>
                                </div>
                            @endif
                                ...
                                <table id="example2" class="table table-bordered table-hover dataTable dtr-inline"
                                    ...
                                    <tr>
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1"
                                            colspan="1"
                                            aria-label="Browser: activate to sort column ascending">{{trans('default.seo_control.seo_key') ?? '關鍵字'}}
                                        </th>
                                    ...
                                    @foreach($datas as $model)
                                        <tr class="odd">
                                            ...
                                            <td>
                                                @if(authPermission('seo-edit'))
                                                    <div class="row mb-1">
                                                        <a href="/admin/seo/edit?id={{$model->id}}"
                                                           class="btn btn-primary">{{trans('default.edit') ?? 編輯}}</a>
                                                    </div>
                                                @endif
                                                @if(authPermission('seo-delete'))
                                                    <div class="row mb-1">
                                                        <form action="/admin/seo/delete" method="post">
                                    ...
                                    <tr>
                                        ...
                                        <th rowspan="1" colspan="1">{{trans('default.seo_control.seo_key') ?? '關鍵字'}}</th>
