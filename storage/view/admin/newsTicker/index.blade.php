            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div id="example2_wrapper" class="dataTables_wrapper dt-bootstrap4">
                        <div class="row">
                            @if(authPermission('newsticker-create'))
                            <div class="col-sm-12 col-md-12 mb-1">
                                <a class="btn badge-info" href="/admin/news_ticker/create">{{trans('default.newsticker_control.newsticker_insert') ?? '新增跑馬燈'}}</a>
                                ...
                                <table id="example2" class="table table-bordered table-hover dataTable dtr-inline"
                                    ...
                                    <tr>
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1"
                                            ...
                                            {{trans('default.name') ?? '名稱'}}
                                        </th>
                                        <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1"
                                            colspan="1"
                                            aria-label="Engine version: activate to sort column ascending">
                                            {{trans('default.content') ?? '內容'}}
                                        </th>
                                        <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1"
                                            colspan="1"
                                            aria-label="Engine version: activate to sort column ascending">
                                    ...
                                    @foreach($datas as $model)
                                        <tr class="odd">
                                            ...
                                            <td>
                                                @if(authPermission('newsticker-edit'))
                                                <div class="row mb-1">
                                                <a href="/admin/news_ticker/edit?id={{$model->id}}" class="btn btn-primary">{{trans('default.edit') ?? '編輯'}}</a>
                                                </div>
                                                @endif

                                                @if(authPermission('newsticker-expire'))
                                                <div class="row mb-1">
                                                    <form action="/admin/news_ticker/expire" method="post">
                                                        <input type="hidden" name="id" value="{{$model->id}}" >
                                                        <input type="hidden" name="expire" value="{{\App\Model\NewsTicker::EXPIRE['yes']}}" >
                                                ...
                                                <div class="row mb-1">
                                                    <form action="/admin/news_ticker/expire" method="post">
                                                        <input type="hidden" name="id" value="{{$model->id}}" >
                                                        <input type="hidden" name="expire" value="{{\App\Model\NewsTicker::EXPIRE['no']}}" >
                                    ...
                                    <tr>
                                        ...
                                        <th rowspan="1" colspan="1">{{trans('default.content') ?? '內容'}}</th>
